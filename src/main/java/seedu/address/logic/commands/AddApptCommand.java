...
public class AddApptCommand extends Command {
    ...
    public static final String MESSAGE_SUCCESS = "New appointment added for the patient: %1$s";
     ...
     */
    public AddApptCommand(String appointment) {
    ...
    public CommandResult execute(Model model) throws CommandException {
         ...
         */
        person.getAppointments().addAppointment(toAdd);
    ...
    public boolean equals(Object other) {
        ...
        return toAdd.equals(otherAddApptCommand.toAdd);
    }
